            ...
            Expanded(
              ...
              children: [
                Row(
                  ...
                  children: [
                    GradientLetter('W',16,8, 42,38),
                    Padding(padding: EdgeInsets.only(left: 10, top: 120)),
                    GradientLetter('O',16,8,42,38),
                    Padding(padding: EdgeInsets.only(left: 10)),
                    GradientLetter('R',16,8,42,38),
                    Padding(padding: EdgeInsets.only(left: 10)),
                    GradientLetter('D',16,8,42,38),
                    Padding(padding: EdgeInsets.only(left: 10)),
                  ],
                ),
                GradientText(text: 'GAME', size: 31.6, fontfamily: 'Ribeye',),
